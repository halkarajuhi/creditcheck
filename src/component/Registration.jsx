    ...
    function submitData(e) {
        ...
        .then(res => {
            if (res.data.success == false) {
                ...
                if(btnR.current){
                    btnR.current.removeAttribute("disabled");
                  }
            } else {
                        ...
                        <div className="tab-pane fade show active" id="corporate" role="tabpanel" aria-labelledby="corporate-tab">
                            <form className="regist_form" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="">
                                            <select name="nationality" className={`form-control form-select nation_select ${errors.nationality ? 'is-invalid' : ''}`} onChange={e => onInputChange(e)} >
                                ...
                                <div className="registar_btn text-center">
                                    <button className="guest_login " type="submit" ref = {btnRef}  >Register</button>
                        ...
                        <div className="tab-pane fade" id="individual" role="tabpanel" aria-labelledby="individual-tab">
                            <form className="regist_form" onSubmit={handleSubmit2(submitData)}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="">
                                            <select className={`form-select nation_select ${errors2.nationality_individual ? 'is-invalid' : ''}`} name="nationality_individual" {...register2('nationality_individual')}  onChange={e => onInputChangevalue(e)} >
                                ...
                                <div className="registar_btn text-center">
                                    <button className="guest_login " type="submit"  ref={btnR}>Register</button>
